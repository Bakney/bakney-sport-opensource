...
<div class="subheader py-6 py-lg-8 subheader-transparent" id="kt_subheader">
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <!--begin::Daterange-->
            <a href="/" class="btn btn-fixed-height btn-bg-white btn-text-dark-50 btn-hover-text-primary btn-icon-primary font-weight-bolder font-size-sm px-5 mr-3" id="kt_dashboard_daterangepicker" data-toggle="tooltip" title="" data-placement="top" data-original-title="Select dashboard daterange">
                <span class="opacity-60 font-weight-bolder mr-2" id="kt_dashboard_daterangepicker_title">Today:</span>
                <span class="font-weight-bolder" id="kt_dashboard_daterangepicker_date">Sep 26</span>
            </a>
            <!--end::Daterange-->
            <!--begin::Dropdown-->
