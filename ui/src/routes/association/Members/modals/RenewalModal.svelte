<script>
    ...
    let wizard = {
        ...
        steps: [
            {
                id: 1,
                title: 'Seleziona il tipo di rinnovo',
                description: 'Seleziona il tipo di rinnovo',
            },
            {
                id: 2,
                ...
                {#if wizard.step === 1}
                    ...
                    {#if formData.type === 2 || formData.type === 3}
                        <button type="button" class="btn btn-primary font-weight-bolder" on:click={() => wizard.step++}
                            >Continua</button>
                    {:else}
                        <button type="submit" class="btn btn-primary font-weight-bolder">Rinnova</button>
                    {/if}
