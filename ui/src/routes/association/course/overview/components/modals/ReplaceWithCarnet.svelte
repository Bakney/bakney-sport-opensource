<script>
    ...
    onMount(() => {
        jQuery(`#replace-with-carnet-modal`).on('shown.bs.modal', () => {
            fetchData();
        });
    });
    ...
    async function updateData() {
        ...
        jQuery(`#replace-with-carnet-modal`).modal('hide');
        updating = false;
    }
</script>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Sostituisci pagamenti con Carnet</h5>
            ...
            <div class="modal-body">
                <div>
                    <p>Seleziona il carnet da sostituire ai pagamenti non ancora saldati.</p>
            ...
            <div class="modal-footer">
                ...
                <button
                    ...
                    {:else}
                        Sostituisci pagamenti con carnet
                    {/if}
                </button>
            </div>
        </div>
