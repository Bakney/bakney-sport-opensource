<script>
    ...
    jQuery(document).ready(function () {
        jQuery('#kt_datetimepicker_bornDate_tutor').datetimepicker({
            ...
            defaultDate: moment(formData.associate_tutor_data.born_date, 'MM-DD-YYYY'),
        });

        jQuery('#kt_datetimepicker_bornDate_tutor').on('change.datetimepicker', function (e) {
            formData.associate_tutor_data.born_date = document.getElementById('date_input_born_date_tutor').value;
        });
        ...
        jQuery('#kt_inputmask_cap_tutor').change(function () {
            formData.associate_tutor_data.address_cap = document.getElementById('kt_inputmask_cap_tutor').value;
        });
        ...
        jQuery('#kt_inputmask_phone_tutor').change(function () {
            formData.associate_tutor_data.phone = document.getElementById('kt_inputmask_phone_tutor').value;
        });
    });
</script>

<!-- INFORMAZIONI TUTORE DEL MINORE-->
<div class="border-top mt-5 pt-10 pl-3 w-100" style="display: {formData.associate_data.is_minor ? 'block' : 'none'}">
    ...
    <div class="form-group">
        ...
        <input
            bind:value={formData.associate_tutor_data.first_name}
    ...
    <div class="form-group">
        ...
        <input
            bind:value={formData.associate_tutor_data.last_name}
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="form-group">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <input
                        bind:value={formData.associate_tutor_data.tax_code}
                    ...
                    <GenerateTaxCodeButton
                        bind:data={formData.associate_tutor_data}
                        on:codice={e => (formData.associate_tutor_data.tax_code = e.detail)} />
                </div>
        ...
        <div class="col-xl-6">
            <div class="form-group">
                ...
                <label>Sesso </label>
                <select
                    bind:value={formData.associate_tutor_data.sex}
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="form-group">
                ...
                <div
                    ...
                    <input
                        bind:value={formData.associate_tutor_data.born_date}
        ...
        <div class="col-xl-6">
            <div class="form-group">
                ...
                <input
                    bind:value={formData.associate_tutor_data.born_city}
    ...
    <div class="form-group">
        ...
        <input
            bind:value={formData.associate_tutor_data.address}
    ...
    <div class="form-group">
        ...
        <input
            bind:value={formData.associate_tutor_data.address_city}
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="form-group">
                ...
                <label>Cap </label>
                <input
                    bind:value={formData.associate_tutor_data.address_cap}
        ...
        <div class="col-xl-6">
            <div class="form-group">
                <!-- svelte-ignore a11y-label-has-associated-control -->
                <label
                    >Cellulare {sportAssociationData.user.sport_association.configuration.mandatory_tutor_phone
                        ? '*'
                        : '(opzionale)'}</label>
                <input
                    bind:value={formData.associate_tutor_data.phone}
    ...
    <div class="form-group">
        <!-- svelte-ignore a11y-label-has-associated-control -->
        <label
            >Email {sportAssociationData.user.sport_association.configuration.mandatory_tutor_email
                ? '*'
                : '(opzionale)'}</label>
        <input
            bind:value={formData.associate_tutor_data.email}
